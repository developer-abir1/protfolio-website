          ...
          <div className=" relative flex  items-center px-4 ">
            <div className="">
              ...
              <p className="  mt-8 text-gray-200  text-justify">
                ...
                WEB Developer I am working with React, Node.js and MongoDB. I
                also have experience in developing static websites using HTML5,
                CSS3 and JavaScript (ES6). I am a quick learner. I believe in
                hard work and efficiency. That's why I am always ready to
                accomplish any task by working hard. I always focus on learning
